...
{
public:
    ASPOSE_DLL_EXPORT SummarizationApi( std::shared_ptr<ApiClient> apiClient );
    ASPOSE_DLL_EXPORT ~SummarizationApi();
    /// <summary>
    ...
    ASPOSE_DLL_EXPORT pplx::task<HttpContent> getDetectHtmlKeywords(
    ...
    ASPOSE_DLL_EXPORT pplx::task<HttpContent> getDetectHtmlKeywordsByUrl(
