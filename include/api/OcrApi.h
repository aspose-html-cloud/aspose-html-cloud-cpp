...
{
public:
    ASPOSE_DLL_EXPORT OcrApi( std::shared_ptr<ApiClient> apiClient );
    ASPOSE_DLL_EXPORT ~OcrApi();
    /// <summary>
    ...
    ASPOSE_DLL_EXPORT pplx::task<HttpContent> getRecognizeAndImportToHtml(
    ...
    /// <param name="folder">The source image folder. (optional)</param>
    /// <param name="storage">The source image storage. (optional)</param>
    ASPOSE_DLL_EXPORT pplx::task<HttpContent> getRecognizeAndTranslateToHtml(
        utility::string_t name,
